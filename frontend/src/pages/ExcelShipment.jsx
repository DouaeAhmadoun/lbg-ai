        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
          ...
          <div
            ...
            className={`border-2 border-dashed rounded-lg p-8 text-center transition-colors ${
              isDragging ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : clientData ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-300 dark:border-gray-600 hover:border-blue-400 hover:bg-gray-50 dark:hover:bg-gray-700'
          ...
          >
            ...
            <div className="flex flex-col items-center">
              ...
              {clientData && uploadedFileName ? (
                <>
                  <p className="text-base font-medium text-gray-900 dark:text-gray-100 mb-1">{uploadedFileName}</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">✓ {clientData.total_records} records loaded · Click to change</p>
                </>
              ) : (
                <>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">.xlsx files only</p>
                </>
              )}
            </div>
          </div>
